...
//    final assetsImage = new AssetImage(pathToIcon);
//    final image = new Image(image: assetsImage, width: 60, height: 60);
    ...
    final column = new Column(
      ...
      children: <Widget>[
        ...
        Text(
          ...
          labelName,
          style: /*TextStyle(fontSize: 14.0)*/ Theme.of(context).textTheme.subhead,
        )
      ],
    );
